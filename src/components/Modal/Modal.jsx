        ...
        <div className="modal-content">
          <div className="card">
            <div className="card-header">
              <div className="card-header-title">{sharedCodeId ? 'Copy Share URL' : 'Read me'}</div>
            ...
            <div className="card-content">
              {
                ...
                <div className="info-content">
                  <p className={styles.fontInfo}>스크립트에서 실행되고 있는 지점을 기준으로 closure의 실행 context 속성들이 배경에 나타납니다.</p>
